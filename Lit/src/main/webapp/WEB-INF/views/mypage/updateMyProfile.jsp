...
// 	회원정보 수정창에서 비밀번호 형식 검사
	var validPwForUpdate=true;
	var validRepwForUpdate=true;
...
<td><input type="text" id="name-for-update" style="width:40%; height:40px; font-size:16px; padding-left:10px;" value="${member.mem_name }" />
...
<td style="padding-bottom:15px;"><input id="pw-for-update" type="password" style="width:40%; height:40px; font-size:16px; padding-left:10px;" value="${member.mem_pw }" />
...
<td><input id="mem-phone-for-update" type="text" style="width:27%; height:40px; font-size:16px; padding-left:10px;" value="${member.mem_phone }" />
...
<tr><td colspan="2" style=" color:#565;"><textarea rows="10" style="width:99%;">${member.mem_intro }</textarea>
