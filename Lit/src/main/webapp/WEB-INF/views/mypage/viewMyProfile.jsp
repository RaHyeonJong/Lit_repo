...
<tr><td style="text-align:center; padding-top: 30px;"><img width="300px" height="300px" style="border:5px solid #999; border-radius:50%;" src="/resources/images/${member.stored_name }"/></td></tr>
