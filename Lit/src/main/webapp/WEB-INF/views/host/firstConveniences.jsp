		...
		<div class="innerleft">
			<div><h4>숙소의 편의시설을 선택해주세요</h4></div>
				<div>
					...
					<label><input type="checkbox"/>무선인터넷</label><br>
					<label><input type="checkbox"/>샴푸</label><br>
					<label><input type="checkbox"/>옷장/서랍장</label><br>
					<label><input type="checkbox"/>TV</label><br>
					<label><input type="checkbox"/>난방</label><br>
					<label><input type="checkbox"/>에어컨</label><br>
					<label><input type="checkbox"/>업무가능공간</label><br>
					<label><input type="checkbox"/>벽난로</label><br>
					<label><input type="checkbox"/>다리미</label><br>
					<label><input type="checkbox"/>헤어드라이어</label><br>
					<label><input type="checkbox"/>게스트 전용 출입문</label><br>
				</div>
			<br>
